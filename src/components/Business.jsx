  ...
  <section id="business" className={layout.section}>
      ...
      <div className={styles.heading3}>
        主要业务： <br className="sm:block hidden" />
          <p className={`${styles.paragraph} text-[20px] text-gray-600 ${styles.descriptionMax} mb-20`}>
              LTCC/HTCC生产设备，LTCC后道工艺设备，检测设备，微组装设备
          </p>
          技术合作：<br className="sm:block hidden" />
          <p className={`${styles.paragraph} text-[20px] text-gray-600 ${styles.descriptionMax} mb-20`}>德国IMST微波组件、芯片设计、技术合作和引进 </p>
      </div>
    </div>

    <div className={`flex-col items-start max-w-[800px] ${styles.sectionPadding}`}>
